    ...
    <>
      ...
      <DayPicker
        ...
        classNames={{
          ...
          day_selected:
            "bg-brand-brown-dark text-brand-brown-dark-foreground hover:bg-brand-brown-dark hover:text-brand-brown-dark-foreground focus:bg-brand-brown-dark focus:text-brand-brown-dark-foreground",
